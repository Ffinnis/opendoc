...
final class NativeAgentCommands {
    ...
    private func schema() throws -> [String: Any] {
        ["version": 1,
         ...
         "customOutput": ["value": "text or number", "detail": "optional text", "progress": "optional number 0...1", "style": CustomWidgetOutput.styles, "tint": CustomWidgetOutput.tints, "symbol": "optional SF Symbol name", "apps": "optional list of up to 4 bundle identifiers; Claude can use the installed CodexBar logo when Claude Desktop is absent", "unsupportedPresentation": "ignored"],
